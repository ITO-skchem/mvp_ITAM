...
PRODUCT_VERSION_GROUPS = {
    ...
    "os": {
        ...
        "codes": [
            ...
            _inv("os_centos_7", "CentOS", "7", "centos", "centos", "7"),
            _inv("os_centos_stream_9", "CentOS Stream", "9", "centos", "centos_stream", "9"),
            ...
            _inv("os_fedora_39", "Fedora", "39", "fedoraproject", "fedora", "39"),
            _inv("os_fedora_40", "Fedora", "40", "fedoraproject", "fedora", "40"),
            ...
            _inv("os_opensuse_leap_15_6", "openSUSE Leap", "15.6", "opensuse", "leap", "15.6"),
            # Linux 커널 버전
            _inv("os_linux_kernel_4_14", "Linux Kernel", "4.14", "linux", "linux_kernel", "4.14"),
            _inv("os_linux_kernel_4_19", "Linux Kernel", "4.19", "linux", "linux_kernel", "4.19"),
            _inv("os_linux_kernel_5_4", "Linux Kernel", "5.4", "linux", "linux_kernel", "5.4"),
            _inv("os_linux_kernel_5_10", "Linux Kernel", "5.10", "linux", "linux_kernel", "5.10"),
            _inv("os_linux_kernel_5_15", "Linux Kernel", "5.15", "linux", "linux_kernel", "5.15"),
            _inv("os_linux_kernel_6_1", "Linux Kernel", "6.1", "linux", "linux_kernel", "6.1"),
            _inv("os_linux_kernel_6_6", "Linux Kernel", "6.6", "linux", "linux_kernel", "6.6"),
